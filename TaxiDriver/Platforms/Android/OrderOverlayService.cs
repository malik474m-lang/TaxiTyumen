...
#pragma warning restore CA1422
    ...
    private void BuildOverlay()
    {
        ...
        var app = CreateButton("Заказ", "#3F3F46", 1f);
        app.Click += (_, _) =>
        {
        ...
        var cancelBtn = CreateButton("Отмена заказа", "#52525B", 1.6f);
        cancelBtn.Click += (_, _) =>
        {
            YandexNavigatorLauncher.BringAppToFront();
            NavigatorOverlay.RaiseAction("cancel");
        };
        tools.AddView(cancelBtn);

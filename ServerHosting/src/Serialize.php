...
final class Serialize
{
    public static function order(\PDO $db, array $o): array
    {
        ...
        return [
            ...
            'pricingMode' => $o['pricing_mode'] ?? 'tariff',
            'isFixedPrice' => ($o['pricing_mode'] ?? 'tariff') === 'zone',
    ...
    public static function driver(array $d): array
    {
        ...
        return [
            ...
            'photoDriverUrl' => DriverPhotos::url($d['id'], 'driver', $d['photo_driver'] ?? null),
            'photoLicenseUrl' => DriverPhotos::url($d['id'], 'license', $d['photo_license'] ?? null),
            'photoCarUrl' => DriverPhotos::url($d['id'], 'car', $d['photo_car'] ?? null),

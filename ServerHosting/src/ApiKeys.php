...
final class ApiKeys
{
    ...
    public const REGISTRY = [
        ...
        'tomtom_traffic' => [
            'label' => 'TomTom (все сервисы: карты, пробки, маршруты, поиск)',
            'const' => 'TOMTOM_API_KEY',
            'hint' => 'developer.tomtom.com (кабинет MyTomTom) — один ключ на все сервисы: бесплатно '
                . '50 000 тайлов и 2 500 остальных запросов в сутки. Какие именно сервисы включены — '
                . 'раздел «TomTom». URL тайлов попадает в приложение водителя, как и JS-ключ Яндекса.',

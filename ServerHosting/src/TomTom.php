...
final class TomTom
{
    ...
    public const REGISTRY = [
        ...
        'map_tiles' => [
            ...
            'hint' => 'Фирменная карта TomTom с русскими подписями вместо OpenStreetMap. '
                . 'Выключите, если нужен полный офлайн города: кнопка «Скачать карту города» '
                . 'в приложении работает только с тайлами OSM.',
            'kind' => 'tile',
            'default' => true,
        ],
        'routing' => [
